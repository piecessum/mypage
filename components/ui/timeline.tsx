...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div ref={ref} className="relative mx-auto max-w-6xl px-6 pb-20">
        {data.map((item, index) => (
          <div
            key={index}
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-indigo-500 from-[0%] via-purple-500 via-[10%] to-transparent"
          />
        </div>
      </div>
    </div>
